                ...
                <div className="grid gap-4">
                    {filteredMessages.map((msg) => (
                        ...
                        >
                            ...
                            <div className={`p-4 rounded-lg bg-main/40 border border-zinc-800/50 text-zinc-300 whitespace-pre-wrap break-words ${!msg.read && 'text-zinc-100'}`}>
                                {safeRender(msg.message, "Content hidden for security reasons.")}
                            </div>
                        </div>
                    ))}
                </div>
