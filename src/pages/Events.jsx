                ...
                <div className="past-event-card cursor-pointer group h-full">
                  ...
                  {event.thumbnailUrl ? (
                    <div style={{ width: '100%', height: '120px', marginBottom: '1rem', borderRadius: '8px', overflow: 'hidden', position: 'relative' }}>
                      ...
                      />
                      <div style={{ display: 'none', width: '100%', height: '100%', background: 'linear-gradient(135deg,#0a0a0a,#111)', alignItems: 'center', justifyContent: 'center', borderRadius: '8px', position: 'absolute', top: 0, left: 0 }}>
                        <span style={{ color: '#00f3ff', fontSize: '0.7rem', fontFamily: 'monospace', letterSpacing: '2px', opacity: 0.6 }}>PHOTO COMING SOON</span>
                      </div>
                    </div>
                  ) : (
                    <div style={{
